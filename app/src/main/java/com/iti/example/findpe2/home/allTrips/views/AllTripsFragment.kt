...
class AllTripsFragment : Fragment() {
    ...
    private lateinit var allTripsViewModel:AllTripsViewModel
    ...
    override fun onCreateView(
        ...
        allTripsViewModel = ViewModelProvider(this).get(AllTripsViewModel::class.java)
        binding.allTripViewModel = allTripsViewModel

        allTripsViewModel.setAllTrips(AllTripsFragmentArgs.fromBundle(requireArguments()).allTrips.asList(),AllTripsFragmentArgs.fromBundle(requireArguments()).allSavedTripsIDs.asList())
